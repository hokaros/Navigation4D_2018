Shader "4D/PerspectiveShader for Solid Mesh"
{
    Properties
    {
    ...
    { 
        ...
        Pass
        {
            ...
            [maxvertexcount(8)]
            void geom(triangle v2g i[3], inout TriangleStream<g2f> outPositions)
            {
                bool shouldRender1 = i[0].shouldRender;
                bool shouldRender2 = i[1].shouldRender;
                bool shouldRender3 = i[2].shouldRender;
                ...
                for (int j = 0; j < 3; j++) {
                    o.opacity = i[j].opacity;
                    o.position = i[j].vertex;
                    outPositions.Append(o);
                }
            }
